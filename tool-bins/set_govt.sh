...
export FABRIC_CFG_PATH=/workspaces/config/gov

# Address of the peer
export CORE_PEER_ADDRESS=teraconsortium-govt:7051

# Local MSP for the admin - Commands need to be executed as org admin
export CORE_PEER_MSPCONFIGPATH=/workspaces/config/crypto-config/peerOrganizations/govt.tera.bt/users/Admin@govt.tera.bt/msp

# Address of the orderer
export ORDERER_ADDRESS=orderer.tera.bt:7050

export CORE_PEER_TLS_ENABLED=false
export CORE_PEER_TLS_ROOTCERT_FILE=/workspaces/config/crypto-config/peerOrganizations/govt.tera.bt/peers/gov/tls/ca.crt
